...
void setData ( string txt, int& var, string error  ) {
...
/// captura de datos flotantes validada
void setData ( string txt, double& var, string error  ) {
...
void setData ( string txt , istream& ent , string& var  )
{
    system("cls") ;
    cout << endl << " -> " << txt;
    ent >> ws;
